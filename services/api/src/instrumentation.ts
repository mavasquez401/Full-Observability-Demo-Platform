...
export function initializeTelemetry(): void {
  ...
  // OTLP trace exporter - NodeSDK handles span processor creation internally
  const traceExporter = new OTLPTraceExporter({
    url: `${otlpEndpoint}/v1/traces`,
  });

  // Initialize SDK with tracing and auto-instrumentation
  // Metrics are disabled to avoid version conflicts - use Datadog custom metrics instead
